      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <p class="mb-5">COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness caused by the novel coronavirus SARS-CoV-2. </p>
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-lg-7 text-center mx-auto">
            ...
            <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness caused by the novel coronavirus SARS-CoV-2.</p>
          </div>
        </div>
        <div class="row"> 
          <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness caused by the novel coronavirus SARS-CoV-2. The pandemic emerged in late 2019 and rapidly spread across the globe, leading to widespread illness, death, and significant disruptions to daily life.</p>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="feature-v1 d-flex align-items-center">
            ...
            <div>
              <h3>Protection</h3>
              <span class="d-block">COVID-19, short for</span>
            </div>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="feature-v1 d-flex align-items-center">
            ...
            <div>
              <h3>Prevention</h3>
              <span class="d-block"> spread across the</span>
            </div>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="feature-v1 d-flex align-items-center">
            ...
            <div>
              <h3>Treatments</h3>
              <span class="d-block">death, and significant disruptions</span>
            </div>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="feature-v1 d-flex align-items-center">
            ...
            <div>
              <h3>Symptoms</h3>
              <span class="d-block">The pandemic emerged</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="row">
              <div class="col-6 col-lg-6 mt-lg-5">
                <div class="media-v1 bg-1">
                  ...
                  <div class="body">
                    <h3>Stay at home</h3>
                    <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious </p>
                  </div>
                </div>
          ...
          <div class="col-lg-5 ml-auto">
            ...
            <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness caused by the novel coronavirus SARS-CoV-2. The pandemic emerged in late 2019 and rapidly spread across the globe, leading to widespread illness, death, and significant disruptions to daily life.</p>
            <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness caused by the novel coronavirus SARS-CoV-2. The pandemic </p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 mx-auto text-center">
            ...
            <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious widespread illness, death, and significant disruptions to daily life.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              ...
              <div class="text">
                <h3>Cough</h3>
                <p>COVID-19, short for "Coronavirus Disease 2019," is a highly contagious respiratory illness.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
