...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 text-center mx-auto">
                        <span class="d-block subheading">LogIn</span>
                        <h1 class="heading mb-3">SignIn Your Account</h1>
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input type="file" id="file" name="image" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="submit" class="btn btn-primary" name="login_btn" value="LogIn An Account">
                                </div>
                            </div>
    ...
    if (isset($_POST['login_btn'])) {
        ...
        if (password_verify($password, $checkpassword)) {
            echo "<script>alert('you are successfully Login'); window.location.href='index.php';</script>";
            $_SESSION['login'] = $image;
            $_SESSION['name'] = $name;
            $_SESSION['email'] = $email;
            $_SESSION['hospital'] = '<a href="hospital.php" class="nav-link">Hospital</a>';
